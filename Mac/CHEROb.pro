...
#
###########################################################################
# When build and deploy the application on Mac OSX 10.6.8,
# copy CHEROb.pro, CHEROb.qrc, gmap.html, gmap.js to the root folder.
###########################################################################
# Third-Party APIs List:
# Qt-4.7.4
# /Developer/Tools/Qt:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/lib:/Developer/Applications/Qt/plugins/imageformats:/Developer/Applications/Qt/plugins
# VTK-5.8
# ITK-4.0.0
# QWT-6.1.0
...
HEADERS += ./src/mainWindow.h \
    ...
    ./src/function/videoFilter.h \
    ./src/function/videoGenerator.h \
    ./src/function/videoNoteFilter.h \
    ./src/function/videoSetup.h \
    ./src/function/mapKit/mapCoordinate.h \
    ./src/function/mapKit/mapCoordinateRegion.h \
    ./src/function/mapKit/mapCoordinateSpan.h \
    ./src/function/mapKit/mapKit.h \
    ./src/function/mapKit/mapView.h \
    ./src/function/mapKit/mapWidget.h \
    ./src/io/hsh.h \
...
SOURCES += ./src/main.cpp \
    ...
    ./src/function/videoFilter.cpp \
    ./src/function/videoGenerator.cpp \
    ./src/function/videoNoteFilter.cpp \
    ./src/function/videoSetup.cpp \
    ./src/function/mapKit/mapCoordinate.cpp \
    ./src/function/mapKit/mapCoordinateRegion.cpp \
    ./src/function/mapKit/mapCoordinateSpan.cpp \
    ./src/function/mapKit/mapView.cpp \
    ./src/function/mapKit/mapWidget.cpp \
    ./src/io/hsh.cpp \
...
INCLUDEPATH += ../thirdparties/itkvtkglue
...
#===========================================================
# Kitware VTK Library (http://www.vtk.org/) - Visualization and OpenGL, BSD license
INCLUDEPATH += ../thirdparties/vtk

#-----------------------------------------------------------
# MK: Don't use QVTKWidget2!!!
# QVTKWidget2 has a serious bug with Texture Mapping. If you use QVTKWidget2, then, when we move the camera in OpenGL, the texture memory keeps glowing up and crash!
# DON'T USE QVTKWidget2 with TEXTURE MAPPING!!!!
#-----------------------------------------------------------
...
#===========================================================
# OpenCV 2.4.4 on Mac OSX 10.6.8
macx-g++{
INCLUDEPATH += /usr/local/include/opencv2
LIBS += -L/usr/local/lib \
-lopencv_calib3d.2.4.4 -lopencv_contrib.2.4.4 -lopencv_core.2.4.4 -lopencv_features2d.2.4.4 -lopencv_flann.2.4.4 \
-lopencv_gpu.2.4.4 -lopencv_highgui.2.4.4 -lopencv_imgproc.2.4.4 -lopencv_legacy.2.4.4 -lopencv_ml.2.4.4 \
-lopencv_nonfree.2.4.4 -lopencv_objdetect.2.4.4 -lopencv_photo.2.4.4 -lopencv_stitching.2.4.4 -lopencv_ts.2.4.4 \
-lopencv_video.2.4.4 -lopencv_videostab.2.4.4
}
#===========================================================
# BOOST library (Template library)
macx-g++{
INCLUDEPATH += /usr/local/include/boost
}
#===========================================================
