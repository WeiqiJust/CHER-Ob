...
bool ReadHyper3D::read3D(QString filename, std::vector<std::string> &channelnames, std::vector<float> &wavelengths, QString &texturefilenameout, std::vector<Material> &materials, vtkPolyData *(&polyData), vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
...
bool ReadHyper3D::readWRL(QString filename, std::vector<std::string> &channelnames, std::vector<float> &wavelengths, QString &texturefilenameout, std::vector<Material> &materials, vtkPolyData *(&polyData), vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
  // parse filename
  QFileInfo fi(filename);
...
bool ReadHyper3D::readOBJ(QString objfilename, std::vector<std::string> &channelnames, std::vector<float> &wavelengths, QString &texturefilenameout, std::vector<Material> &materials, vtkPolyData *(&polyData), vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
  // parse filename
...
bool ReadHyper3D::readPLY(QString filename, std::vector<std::string> &channelnames, std::vector<float> &wavelengths, QString &texturefilenameout, std::vector<Material> &materials, vtkPolyData *(&polyData), vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
  // parse filename
  QFileInfo fi(filename);
...
bool ReadHyper3D::readAnyTexture(QString filename, std::vector<std::string> &channelNames, std::vector<float> &wavelengths, QString &filenameout, vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
...
bool ReadHyper3D::readATexture(QString texturefilename, std::vector<std::string> &channelNames, std::vector<float> &wavelengths, vtkTexture *(&rgbTexture), vtkImageData *(&hyperImageData), bool &isTextureOn)
{
...
bool ReadHyper3D::readEXR(QString filename, std::vector<std::string> &channelnames, std::vector<float> &wavelengths, vtkTexture *(&rgbTexture), vtkImageData* (&rgbImageData), vtkImageData *(&hyperImageData))
{
  // parse filename
  QFileInfo fi(filename);
...
//  QString fileName("@executable_path/../Resources/Hyper3D_Logo128.png");
...
bool ReadHyper3D::readPNG(QString filename, vtkTexture *(&texture) )
{
  QFileInfo fi(filename);
  if(!fi.exists())
  {
...
bool ReadHyper3D::readBMP(QString filename, vtkTexture *(&texture) )
{
  QFileInfo fi(filename);
  if(!fi.exists())
  {
...
bool ReadHyper3D::readTIF(QString filename, vtkTexture *(&texture) )
{
  QFileInfo fi(filename);
  if(!fi.exists())
  {
...
bool ReadHyper3D::readJPG(QString filename, vtkTexture *(&texture) )
{
  QFileInfo fi(filename);
  if(!fi.exists())
  {
...
void ReadHyper3D::CreateRGBImage(vtkImageData* image, int width, int height, int channels = 3)
{
...
void ReadHyper3D::CreateHyperImage(vtkImageData* image, int width, int height, int channels)
{
  image->SetDimensions(width, height, 1);
...
void ReadHyper3D::updatePolyData(vtkPolyData *(&polyData), vtkDataArray *(&tCoords), vtkDataArray *(&normals))
{
  //================================================================================
...
bool ReadHyper3D::parseOBJ(QString objfilename, QString & mtlfilename)
{
...
Material * ReadHyper3D::createMaterial() {
...
bool ReadHyper3D::parseMTL(QString mtlfilename, std::vector<Material> &materials)
{
...
bool ReadHyper3D::parsePLY(QString filename, std::vector<Material> &materials)
{
...
int ReadHyper3D::readNextToken(FILE *f, char *s )
{
  int len, res;
...
bool ReadHyper3D::readMaterial(FILE *f, Material * material)
{
...
int ReadHyper3D::updateProgress(int pos)
{
  static int q=0;
...
void ReadHyper3D::setTotal(int size)
{
  mw()->qb->setMaximum(size);
}


bool ReadHyper3D::parseWRL2(QString filename, std::vector<Material> &materials)
{
  FILE *in = fopen( filename.toLocal8Bit().constData(), "rb" );
