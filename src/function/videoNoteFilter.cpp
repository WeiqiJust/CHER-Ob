...
VideoNoteFilter::VideoNoteFilter(QVector<QString> objects)
{
	mDialog = new QDialog();
...
QVector<QString> VideoNoteFilter::getFilterList()
{
...
QVector<int> VideoNoteFilter::getCategories(const QString object)
{
...
void VideoNoteFilter::selectAll()
{
	for (int i = 0; i < mItems.size(); i++)
	{
...
void VideoNoteFilter::itemChanged(QTreeWidgetItem* item, int column)
{
