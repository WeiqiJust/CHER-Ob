...
#include "../../../src/function/normalsrendering.h"
...
void NormalsRendering::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData NormalsRendering::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject NormalsRendering::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NormalsRendering,
      qt_meta_data_NormalsRendering, &staticMetaObjectExtraData }
};
